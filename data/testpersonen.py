...
TESTPERSONEN: list[Testperson] = [
    ...
    Testperson('010861276', 'Leon', 'OmnIA', date(1973, 5, 8), 'Alexanderplatz 1', '10178', 'Berlin'),
    ...
    Testperson('010861322', 'Tim', 'OmnIA', date(2002, 10, 5), 'Alexanderplatz 1', '10178', 'Berlin'),
    ...
    Testperson('010862361', 'Paul', 'OmnIA', date(1989, 11, 13), 'Domkloster 4', '50667', 'Köln'),
    Testperson('010862370', 'Laura', 'OmnIA', date(2002, 8, 3), 'Marienplatz 1', '80331', 'München'),
    Testperson('010862388', 'Max', 'OmnIA', date(2001, 4, 7), 'Schiffbeker Weg 199', '22119', 'Hamburg'),
