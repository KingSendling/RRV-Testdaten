...
Name, Vorname, Geburtsdatum und Adresse mit einer von 187 vordefinierten
...
data/testpersonen.py                187 vordefinierte Testpersonen (Mgl.-Nr., Name, Geburtsdatum, Adresse)
